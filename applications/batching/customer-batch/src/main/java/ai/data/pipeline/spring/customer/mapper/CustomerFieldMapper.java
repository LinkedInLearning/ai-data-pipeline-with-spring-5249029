package ai.data.pipeline.spring.customer.mapper;

import org.springframework.batch.item.file.mapping.FieldSetMapper;
import org.springframework.batch.item.file.transform.FieldSet;
import org.springframework.stereotype.Component;
import org.springframework.validation.BindException;
import ai.data.pipeline.spring.customer.domain.Contact;
import ai.data.pipeline.spring.customer.domain.Customer;
import ai.data.pipeline.spring.customer.domain.Location;
